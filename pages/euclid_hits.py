...
try:
	...
	pmd = []
	mdutil.build_markdown(__name__,"start_post","Figure1","assets/Fig1_euclid_hits.png",pmd)
	mdutil.build_markdown(__name__,"Figure1","Figure2","assets/Fig2_euclid_hits.png",pmd)
	mdutil.build_markdown(__name__,"Figure2","",None,pmd)
