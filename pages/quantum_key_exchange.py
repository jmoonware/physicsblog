...
try:
	...
	pmd = []
	mdutil.build_markdown(__name__,"start_post","Figure1","assets/Fig1_quantum_key_exchange.png",pmd,width=500)
	mdutil.build_markdown(__name__,"Figure1","Figure2","assets/Fig2_quantum_key_exchange.png",pmd,width=600)
	mdutil.build_markdown(__name__,"Figure2","Figure3","assets/Fig3_quantum_key_exchange.png",pmd)
